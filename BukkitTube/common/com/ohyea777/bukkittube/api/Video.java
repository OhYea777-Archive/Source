			...
			public void run() {
				...
				try {
					...
					if (videoCoder.getPixelType() != Type.BGR24) {
						resampler = IVideoResampler.make(videoCoder.getWidth(), videoCoder.getHeight(), Type.BGR24, videoCoder.getWidth(), videoCoder.getHeight(),
						...
						if (packet.getStreamIndex() == videoStreamId) {
							...
							while (offset < packet.getSize()) {
								...
								if (picture.isComplete()) {
									...
									if (newPic.getPixelType() != Type.BGR24)
									...
									IConverter con = new ArgbConverter(Type.BGR24, newPic.getWidth(), newPic.getHeight(), 128, 128);
